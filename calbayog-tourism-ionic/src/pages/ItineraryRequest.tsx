...
const ItineraryRequest: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!form.travelDateStart) return "Please select an arrival date.";
    if (!form.travelDateEnd) return "Please select a departure date.";
    ...
    try {
      ...
      try {
        await createNotification({
          userId: "all", // Will be handled by backend to notify admins
          type: "trip_request",
    ...
    return (
      <Container className="py-5 text-center" style={{ maxWidth: 500 }}>
        ...
        <p className="text-muted mb-4">
          We've received your itinerary request. A confirmation email has been
          sent, and our team will contact you within 2–3 business days.
        </p>
        ...
        <Card className="border-0 shadow-tourism rounded-xl">
          <Card.Body className="p-4">
            ...
            <Form onSubmit={handleSubmit} noValidate>
              ...
              <Row className="g-3 mb-4">
                <Col xs={12} sm={6}>
                  ...
                  <Form.Control
                    ...
                    isInvalid={touched.fullName && !form.fullName.trim()}
                ...
                <Col xs={12} sm={6}>
                  ...
                  <Form.Control
                    ...
                    isInvalid={touched.email && !isValidEmail(form.email)}
                ...
                <Col xs={12} sm={6}>
                  ...
                  <Form.Control
                    ...
                    isInvalid={touched.phone && !isValidPhone(form.phone)}
              ...
              <h6 className="fw-bold mb-3 text-green">🗓️ Travel Details</h6>
              <Row className="g-3 mb-4">
                <Col xs={12} sm={6}>
                  <Form.Label className="fw-semibold">
                    Arrival Date *
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      handleChange("travelDateStart", e.target.value)
                    }
                    onBlur={() =>
                      setTouched((t) => ({ ...t, travelDateStart: true }))
                    }
                    isInvalid={touched.travelDateStart && !form.travelDateStart}
                  />
                  <Form.Control.Feedback type="invalid">
                ...
                <Col xs={12} sm={6}>
                  ...
                  <Form.Control
                    required
                    type="date"
                    min={form.travelDateStart || todayStr()}
                    value={form.travelDateEnd}
                    onChange={(e) =>
                      handleChange("travelDateEnd", e.target.value)
                    }
                    onBlur={() =>
                      setTouched((t) => ({ ...t, travelDateEnd: true }))
                    }
                    isInvalid={
                      touched.travelDateEnd &&
                      (!form.travelDateEnd ||
                        form.travelDateEnd < form.travelDateStart)
                    }
                  />
                  <Form.Control.Feedback type="invalid">
                ...
                <Col xs={12} sm={4}>
                  <Form.Label className="fw-semibold">Group Size *</Form.Label>
                  <Form.Control
                    required
                    type="number"
                    min={1}
                    ...
                    onBlur={() =>
                      setTouched((t) => ({ ...t, groupSize: true }))
                    }
                    isInvalid={
                      touched.groupSize &&
                      (!form.groupSize || form.groupSize < 1)
                    }
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <h6 className="fw-bold mb-3 text-green">📍 Preferred Spots</h6>
              <p className="text-muted mb-2" style={{ fontSize: "0.85rem" }}>
                Select the destinations you'd like to visit:
              </p>
              <div className="d-flex flex-wrap gap-2 mb-3">
                {destinations.map((d) => {
                  const selected = form.preferredSpots.includes(d.name);
                  return (
                    <button
                      key={d.id}
                      type="button"
                      onClick={() => toggleSpot(d.name)}
                      ...
                      style={{
                        ...
                        background: selected
                          ? "var(--tropical-green)"
                          : "transparent",
                        color: selected ? "#fff" : "var(--tropical-green)",
                        cursor: "pointer",
              ...
              {form.preferredSpots.length > 0 && (
                <div className="mb-4 d-flex flex-wrap gap-1 align-items-center">
                  ...
                  <button
                    ...
                    onClick={() => handleChange("preferredSpots", [])}
                  >
                    Clear all
                  </button>
                </div>
              ...
              <h6 className="fw-bold mb-3 text-green">🛎️ Services Needed</h6>
              <div className="d-flex flex-wrap gap-4 mb-4">
                <Form.Check
                  ...
                  onChange={(e) =>
                    handleChange("accommodationNeeded", e.target.checked)
                  }
                />
                <Form.Check
                  type="checkbox"
                  ...
                  onChange={(e) =>
                    handleChange("guideNeeded", e.target.checked)
                  }
                />
              </div>

              <h6 className="fw-bold mb-3 text-green">📝 Special Requests</h6>
              <Form.Control
                as="textarea"
                rows={3}
                className="mb-4"
              ...
              <div className="d-flex gap-2">
                <Button
                  ...
                  disabled={loading}
                >
                  {loading ? "⏳ Submitting..." : "📤 Submit Itinerary Request"}
                </Button>
                <Button
                  type="button"
              ...
              >
                A confirmation email will be sent to your inbox. We'll respond
